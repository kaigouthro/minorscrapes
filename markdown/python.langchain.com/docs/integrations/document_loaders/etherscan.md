...
You can pass different filters to loader to access different functionalities we mentioned above:
  ...
  * "eth_balance"
  * "erc721_transaction"
  * "erc1155_transaction" The filter is default to normal_transaction

If you have any questions, you can access Etherscan API Doc or contact me via i@inevitable.tech.
