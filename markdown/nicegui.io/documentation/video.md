...
URL or local file path of the video source

controls:

    

whether to show the video controls, like play, pause, and volume (default: True)

autoplay:

    

whether to start playing the video automatically (default: False)

muted:

    

whether the video should be initially muted (default: False)
