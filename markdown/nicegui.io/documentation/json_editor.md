...
dictionary of JSONEditor properties

on_select:

callback function that is called when some of the content has been selected

on_change:

callback function that is called when the content has changed
