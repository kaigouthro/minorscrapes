...
type of spinner (e.g. "audio", "ball", "bars", ..., default: "default")

size:

size of the spinner (e.g. "3em", "10px", "xl", ..., default: "1em")

color:

color of the spinner (either a Quasar, Tailwind, or CSS color or None, default: "primary")

thickness:

thickness of the spinner (applies to the "default" spinner only, default: 5.0)
