...
callback for when the user touches the joystick

on_move:

callback for when the user moves the joystick

on_end:

callback for when the user releases the joystick

throttle:

throttle interval in seconds for the move event (default: 0.05)

options:

arguments like color which should be passed to the underlying nipple.js library
