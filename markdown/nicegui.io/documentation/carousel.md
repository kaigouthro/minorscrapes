...
ui.carousel_slide or name of the slide to be initially selected (default: None meaning the first slide)
...
whether to animate slide transitions (default: False)

arrows:

whether to show arrows for manual slide navigation (default: False)

navigation:

whether to show navigation dots for manual slide navigation (default: False)
