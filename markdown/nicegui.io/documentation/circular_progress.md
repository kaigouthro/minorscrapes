...
the size of the progress circle (default: "xl")

show_value:

whether to show a value label in the center (default: True)

color:

color (either a Quasar, Tailwind, or CSS color or None, default: "primary")
...
You can put any element like icon, button etc inside a circular progress using the `with` statement. Just make sure it fits the bounds and disable the default behavior of showing the value.
