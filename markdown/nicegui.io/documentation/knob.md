...
knob color (either a Quasar, Tailwind, or CSS color or None, default: "primary")

center_color:

color name for the center part of the component, examples: primary, teal-10

track_color:

color name for the track of the component, examples: primary, teal-10
