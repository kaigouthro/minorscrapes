...
the color name for component (either a Quasar, Tailwind, or CSS color or None, default: "primary")

text_color:

text color (either a Quasar, Tailwind, or CSS color or None, default: None)

outline:

use 'outline' design (colored text and borders only) (default: False)
